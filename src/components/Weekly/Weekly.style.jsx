...
export const WeeklyStyles = ({ children }) => {
  return <div className="px-4 py-8 lg:p-12 flex flex-col md:flex-row gap-12 bg-[#3B3B3B] rounded-2xl items-center"> {children} </div>;
};
